...
//                    electricFanCenterY + textRect.height() / 2.0f, mPaint);
    ...
    private PointF getPoint1(RectF leafFlyRect) {
        ...
        point.x = leafFlyRect.right - mRandom.nextInt((int) (leafFlyRect.width() / 2) > 0 ? (int) (leafFlyRect.width() / 2) : 1);
        point.y = (int) (leafFlyRect.bottom - mRandom.nextInt((int) leafFlyRect.height() > 0 ? (int) leafFlyRect.height() : 1));
        return point;
    }
    ...
    private PointF getPoint2(RectF leafFlyRect) {
        PointF point = new PointF();
        point.x = leafFlyRect.left + mRandom.nextInt((int) (leafFlyRect.width() / 2) > 0 ? (int) (leafFlyRect.width() / 2) : 1);
        point.y = (int) (leafFlyRect.bottom - mRandom.nextInt((int) leafFlyRect.height() > 0 ? (int) leafFlyRect.height() : 1));
        return point;
    }
